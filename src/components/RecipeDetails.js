...
export class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url: `https://www.food2fork.com/api/get?key=5326fb060345ae3e94808f3e40fa19f0&rId=${this.props.id}`
    //     }
    // }
    ...
    async componentDidMount() {
        ...
        const url = `https://www.food2fork.com/api/get?key=5326fb060345ae3e94808f3e40fa19f0&rId=${id}`
        try {
